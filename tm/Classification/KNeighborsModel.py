...
class KNeighborsModel(ClassificationModel):
	...
	def getConfiguration(self):
		cfg_json_str = '{"amountOfTrainingDataSet":"'+str(self.amountOfTrainingDataSet)+'","amountOfTestingDataSet":"'+str(self.amountOfTestingDataSet)+'","n_neighbors":"'+str(self.n_neighbors)+'","displayChart":"'+str(self.displayChart)+'"}'
		return cfg_json_str
	...
	def setConfiguration(self,cfg_json_str):
		...
		self.n_neighbors = int(cfg_json["n_neighbors"])
